...
<head>
  ...
  <script src="https://cloud.tinymce.com/5/tinymce.min.js?apiKey=bo126gblj5m82n8l76jk8pfzz2o0cjr2s48ylx98zjjnjx8v"></script>
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="index.html">Blog Meryem</a>
    ...
    <form class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
      <div class="input-group">
        <input type="text" class="form-control" placeholder="Rechercher un article..." aria-label="Search" aria-describedby="basic-addon2">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <form method="POST" action="?action=creatpost" enctype="multipart/form-data">
      ...
      <footer class="sticky-footer">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright © Meryem Benlhaj <?= date("Y")?></span>
          </div>
        </div>
      </footer>
